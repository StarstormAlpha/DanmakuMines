...
import {
    GAME_DIMENSIONS,
    BRICK_CONSTANTS,
} from '../util/danmakuMinesConstants';
...
export class Brick extends Actor {
    ...
    constructor(row: number, column: number) {
        ...
        let brickWidth =
            GAME_DIMENSIONS.gameWidth / BRICK_CONSTANTS.columns -
            BRICK_CONSTANTS.padding -
            BRICK_CONSTANTS.padding / GAME_DIMENSIONS.gameWidth;
        super({
            width: brickWidth,
            height: BRICK_CONSTANTS.brickHeight,
            x:
                BRICK_CONSTANTS.xOffset +
                column * (brickWidth + BRICK_CONSTANTS.padding) +
                BRICK_CONSTANTS.padding,
            y:
                BRICK_CONSTANTS.yOffset +
                row * (BRICK_CONSTANTS.brickHeight + BRICK_CONSTANTS.padding) +
                BRICK_CONSTANTS.padding,
            color: BRICK_CONSTANTS.brickColors[
                row % BRICK_CONSTANTS.brickColors.length
            ],
        });
    }
